...
This will go through the files at folderPath and update the MediaManager entries accordingly.
EOT
        );
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        foreach ($finder as $file) {
            ...
            try {
                ...
                $media = $this->getContainer()->get('tms_media.manager.media')->retrieveMedia($filename);
